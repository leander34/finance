  ...
  'fixed z-50 gap-4 bg-background shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out',
  {
    variants: {
      side: {
        ...
        right:
          'inset-y-0 right-0 h-full max-h-screen overflow-hidden border data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right gap-0 rounded-tl-md shadow-md',
      },
    },
    defaultVariants: {
      side: 'right',
