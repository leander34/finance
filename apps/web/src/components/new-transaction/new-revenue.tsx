...
const newRevenueFormSchema = z
  .object({
    description: z
      .string({
        required_error: 'Por favor, digite uma descrição para a receita.',
      })
    ...
    category: z
      .string({
        required_error: 'Por favor, selecione a categoria da receita.',
      })
      .uuid(),
  ...
  .refine(
    ...
    },
    {
      ...
      message:
        'Por favor, selecione uma frequência de repetição para a receita fixa.',
    },
  )
  .refine(
    (data) => {
...
type NewRevenueFormData = z.infer<typeof newRevenueFormSchema>
...
export function NewRevenue() {
  ...
  const form = useForm<NewRevenueFormData>({
    resolver: zodResolver(newRevenueFormSchema),
    defaultValues: {
      tags: [],
  ...
  const { data: categoriesData, isLoading: isLoadingCategories } = useQuery({
    queryKey: ['secondary', 'categories', 'revenue', currentOrg],
    queryFn: () => {
      return getRevenueCategoriesHttp(currentOrg)
    },
    enabled: !!currentOrg,
  })
  ...
  const onSubmit: SubmitHandler<NewRevenueFormData> = async (inputs) => {
    console.log('oi')
    if (
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-1 flex-col space-y-1">
                      ...
                      <FormMessage />
                      <FormDescription className="">
                        Data em que a receita foi ou será recebida.
                      </FormDescription>
                    </FormItem>
                  )}
                />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex items-center gap-2 space-y-0">
                        ...
                        <FormLabel>É uma receita única.</FormLabel>
                      </FormItem>
                    )}
                  />
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex items-center gap-2 space-y-0">
                        ...
                        <FormLabel>É uma receita fixa.</FormLabel>
                      </FormItem>
                    )}
                  />
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex items-center gap-2 space-y-0">
                        ...
                        <FormLabel>É uma receita parcelada.</FormLabel>
                      </FormItem>
                    )}
                  />
                </div>
                          ...
                          >
                            <Command shouldFilter={false}>
                              <CommandInput
                                ...
                                placeholder="Crie ou procure uma tag"
                              />
                              <CommandList>
                                <CommandEmpty>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="Use esse campo se desejar descrever mais sobre a receita. Esse campo não é obrigatório."
